...
import { Data, MintingPolicy, PolicyId, UTxO, Unit, applyParamsToScript, fromText } from 'lucid-cardano';
import { AppStateContext } from '@/pages/_app';
import { signAndSubmitTx } from '@/utilities/utilities';

const COMPILED_VALIDATOR_WITHOUT_PARAMS =
  ...
  const getFinalPolicy = (utxo: UTxO): GetFinalPolicy => {
    ...
    const dataTokenPolicy: MintingPolicy = {
      ...
      script: applyParamsToScript<Params>(
        ...
        COMPILED_VALIDATOR_WITHOUT_PARAMS,
