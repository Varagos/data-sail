    ...
    try {
        ...
        if (!nami) {
            ...
            const lucid = await L.Lucid.new(
                new L.Blockfrost("https://cardano-preview.blockfrost.io/api/v0", 'previewsKVSTHsY3c2sWpsRpJRjs9KiOLaSRmht'),
                "Preview",
            );
...
/**
 * Our script address can have anything, since anyone can send anything, anytime to anything at Cardano.
 * So we filter out, only keeping the ones that have a valid datum. (VestingDatum)
 */
